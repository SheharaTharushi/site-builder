		...
		>
			<div className="container mx-auto px-6">
				<div ref={contentRef} className="content-wrapper">
					...
					<div className="max-w-2xl mx-auto bg-white/10 backdrop-blur-md rounded-2xl p-8 md:p-12">
						<form className="space-y-6">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div>
									...
									<input
										type="text"
										id="name"
										className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:ring-2 focus:ring-white/50 focus:outline-none"
							...
							<button
								type="submit"
								className="w-full py-4 bg-white text-blue-600 font-semibold rounded-lg hover:bg-opacity-90 transition-all transform hover:scale-102"
							>
								{buttonText}
							</button>
						</form>
