			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-lg text-gray-600 max-w-3xl mx-auto">
						Our diverse team of experts is passionate about creating exceptional
						digital experiences that help businesses achieve their goals.
					</p>
				</motion.div>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
					...
					>
						...
						<div className="p-6">
							...
							<p className="text-gray-600 mb-4">
								With over 15 years of experience in digital product development,
								Michael leads our team with vision and expertise.
							</p>
					...
					>
						...
						<div className="p-6">
							...
							<p className="text-gray-600 mb-4">
								Sarah brings her creative vision and user-centered approach to
								every project, ensuring beautiful and functional designs.
							</p>
							<div className="flex space-x-3">
								<a href="#" className="text-gray-400 hover:text-primary">
									<svg
					...
					>
						...
						<div className="p-6">
							...
							<p className="text-gray-600 mb-4">
								David's technical expertise and problem-solving skills drive the
				...
				>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
						<div>
							...
							<p className="text-gray-600 mb-4">
								Founded in 2015, we began as a small team with a big vision: to
								create digital experiences that truly make a difference. Today,
								we've grown into a full-service agency working with clients
								around the world.
							</p>
							<p className="text-gray-600">
								Our journey has been defined by our commitment to innovation,
								quality, and client success. As we continue to grow, we remain
								dedicated to our core values and the belief that great design
								and technology can transform businesses.
							</p>
						</div>
